package com.example.yoyoiq.UpComingMatchPOJO;
 ...
 public class ShortSquadsUploadingPojoClass {
     String TeamName;
     String TeamId;
     ...
     public ShortSquadsUploadingPojoClass(String teamName, String teamId, String match_id, String user_id, String captain, String vicecaptain, String teamAName, String teamBName, int batsman, int boller, int allrounder, int wkeeper, int teamAcount, int teamBcount, boolean isSlected) {
         TeamName = teamName;
         TeamId = teamId;
