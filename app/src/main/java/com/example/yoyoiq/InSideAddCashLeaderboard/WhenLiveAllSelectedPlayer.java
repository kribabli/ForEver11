...
public class WhenLiveAllSelectedPlayer {
    int pid;
    ...
    public WhenLiveAllSelectedPlayer(int pid, String matchId, String title, String country, String playing_role, double fantasy_player_rating, boolean added, boolean isCap, boolean isVcap, String points) {
        this.pid = pid;
